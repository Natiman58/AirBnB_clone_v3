#!/usr/bin/python3
"""
    A module that handles the new view for cities
"""
...
def city_get(state_id):
    """
        handles getting all cities from the states
    """
...
def city_get_with_id(city_id):
    """
        gets the city with the specifc id
    """
